...
- `structure/test-reference-docs.sh` - Reference-doc template skeletons (8 layers), INDEX/Code Pointer validation, sync-docs reference logic (55 tests)
...
- Run `bash tests/run-all.sh` to execute all 169 tests
